...
class StandardQF(SimplePositivesQF, BoundedInterestingnessMeasure):
    ...
    are discarded (quality 0, optimistic estimate/generalisation -inf).
    """
    ...
    def __init__(self, a, min_sg_coverage=0.0, max_sg_coverage=1.0):
        """
    ...
    def evaluate(self, subgroup, target, data, statistics=None):
        ...
        Returns 0 if the subgroup is outside the coverage band.
    ...
    def optimistic_estimate(self, subgroup, target, data, statistics=None):
        ...
        Returns -inf if the subgroup is outside the coverage band.
